...
1. Añade el contenido a tu archivo de fragmento que deseas reutilizar en múltiples
   ubicaciones. Opcionalmente, puedes añadir variables que se pueden completar mediante props
